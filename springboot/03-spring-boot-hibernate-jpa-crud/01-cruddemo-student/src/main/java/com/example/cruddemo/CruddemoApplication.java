...
public class CruddemoApplication {
	...
	public static void main(String[] args) {
		...
		private void createMultipleStudents(StudentDAO studentDAO) {
			...
			Student tempStudent1 = new Student("Gary","COPE","garycopes@gmail.com");
			Student tempStudent2 = new Student("Gus","DOPE","gusdopes@gmail.com");
			Student tempStudent3 = new Student("George","TOPE","georgetopes@gmail.com");
